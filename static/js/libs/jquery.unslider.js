...
(function($, f) {
  var Unslider = function() {
    ...
    _.o = {
      ...
      easing: 'easeInOutQuad' // easing function to use for animation
    };
    ...
    _.init = function(el, o) {
      ...
      !o.placeholders && el.css({width: _.max[0], height: li.first().outerHeight()})
      ...
      //  Autoslide
      o.autoslide && setTimeout(function() {
        if (o.delay | 0) {
          _.play();
      ...
      // placeholders paginations (i.e. with cursor )
      o.placeholders && nav('placeholder');
    ...
    _.to = function(index, callback) {
      ...
      if (!ul.queue('fx').length) {
        ...
        // animate cursor
        el.find('.cursor').animate({
          left: (100*index/li.length) + '%'
        },{
          duration: speed,
          easing: easing
        })
    ...
    function nav(name, html) {
      ...
      _.el.addClass('has-' + name).append(html).find('.' + name).click(function() {
        var me = $(this);
        me.hasClass('dot') || me.hasClass('placeholder') ? _.stop().to(me.index()) : me.hasClass('prev') ? _.prev() : _.next();
      });
    };
  };
